<template>
  <div class="p-4">
    ...
    <ColumnRuleList @register="registerDrawer2" />
  </div>
</template>
...
import ColumnRuleList from "./ColumnRuleList.vue";
...
const [registerDrawer2, { openDrawer: openColRule }] = useDrawer();
// 列表页面公共参数、方法
 ...
 * 数据权限弹窗
 */
function handleColRule(record) {
  openColRule(true, { id: record.id });
}
